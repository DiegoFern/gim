{
        ...
        '2'  : Node(File='codes/sum.py',inputs=['0','1'],txt=True
            ,doc=('insert the value of 2th fibbonacci '
                'as the sum of the two previous numbers'
                ),),
        '3'  : Node(File='codes/sum.py',inputs=['1','2'],txt=True,
            doc=('insert the value of 3th fibbonacci '
                'as the sum of the two previous numbers'
                ),),
        '4'  : Node(File='codes/sum.py',inputs=['2','3'],txt=True,
            doc=('insert the value of 4th fibbonacci '
                'as the sum of the two previous numbers'
                ),),
        '5'  : Node(File='codes/sum.py',inputs=['3','4'],txt=True,
            doc=('insert the value of 5th fibbonacci '
                'as the sum of the two previous numbers'
                ),),
        '6'  : Node(File='codes/sum.py',inputs=['4','5'],txt=True,
            stdout=False,
